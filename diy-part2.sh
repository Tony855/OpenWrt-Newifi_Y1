...
git clone https://github.com/kuoruan/openwrt-v2ray.git /package/lean/v2ray-core
git clone -b luci2 https://github.com/kuoruan/luci-app-v2ray.git /package/lean/luci-app-v2ray
